...
class AutoCompleteSuggest extends obsidian.EditorSuggest {
    ...
    onTrigger(cursor, editor, file) {
        ...
        const currentTokenSeparatedWhiteSpace = (_a = currentLineUntilCursor.split(" ").last()) !== null && _a !== void 0 ? _a : "";
        ...
        const trimmedCurrentToken = (_b = this.tokenizer.tokenize(currentToken)) === null || _b === void 0 ? void 0 : _b[0];
