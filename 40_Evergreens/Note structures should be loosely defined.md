...
As you're writing notes your structure shouldn't be constricting your thought it should be encouraging it. If a structure makes you stop and think, "I have no idea what to put in here" it is introducing [[friction]] into the process of creation,
^[[[Your second brain should be frictionless access to a curated base of knowledge]]]
but if it stops and makes you think, "here are all the things I can put in here" it is adding to your process.
...
^[[[Friction is the number one hindrance to learning#Counter Friction can be used to engage the first brain|Friction can be used to engage the first brain]]]
